...
/**
 * States that there is a clash with the creation of an ID.
 */
public class IdClashException extends Exception{
    /**
     ...
     *                method.
     */
    public IdClashException(String message){
        super(message);
    }
     ...
     */
    public IdClashException(String message, Throwable cause){
        super(message, cause);
    }

    /**
     *Constructs a new exception with the specified cause and a detail message of (cause==null ? null : cause.toString())
     * (which typically contains the class and detail message of cause). This constructor is useful for project.exceptions that
     ...
     */
    public IdClashException(Throwable cause){
        super(cause);
    }
     ...
     */
    public IdClashException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace){
