 ...
 * repository.
 */
public class DuplicateDrugException extends DuplicateException {
    /**
     ...
     */
    public DuplicateDrugException(String message, Throwable cause){
        super(message, cause);
    }
     ...
     */
    public DuplicateDrugException(Throwable cause){
        super(cause);
    }
     ...
     */
    public DuplicateDrugException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace){
